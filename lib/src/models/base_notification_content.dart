...
import 'package:plugintest/src/utils/html_utils.dart';
...
class BaseNotificationContent extends Model {
  ...
  void validate() {
    if (AssertUtils.isNullOrEmptyOrInvalid(id, int))
      throw PluginTestException(message: 'Property id is requried');
    if (AssertUtils.isNullOrEmptyOrInvalid(channelKey, String))
      throw PluginTestException(message: 'channelKey id is requried');
  }
}
