...
import 'package:plugintest/src/utils/list_utils.dart';
...
class NotificationAndroidCrontab extends NotificationSchedule {
  ...
  NotificationAndroidCrontab(
      ...
      : super(
            timeZone: timeZone ?? Plugintest.localTimeZoneIdentifier,
  ...
  NotificationAndroidCrontab.fromDate(
      ...
      : super(
            timeZone: date.isUtc
                ? Plugintest.utcTimeZoneIdentifier
                : Plugintest.localTimeZoneIdentifier,
            allowWhileIdle: allowWhileIdle,
            repeats: false) {
