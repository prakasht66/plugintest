...
import 'package:plugintest/src/models/notification_calendar.dart';
import 'package:plugintest/src/models/notification_content.dart';
import 'package:plugintest/src/models/notification_interval.dart';
...
class NotificationModel extends Model {
  ...
  void validate() {
    if (content == null)
      throw PluginTestException(message: 'content is required.');
  }
}
