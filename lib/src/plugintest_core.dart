...
import 'package:plugintest/src/enumerators/media_source.dart';
import 'package:plugintest/src/models/notification_button.dart';
import 'package:plugintest/src/models/notification_channel.dart';
import 'package:plugintest/src/models/notification_content.dart';
import 'package:plugintest/src/models/notification_schedule.dart';
import 'package:plugintest/src/models/notification_model.dart';
import 'package:plugintest/src/models/received_models/received_action.dart';
import 'package:plugintest/src/models/received_models/received_notification.dart';
import 'package:plugintest/src/utils/assert_utils.dart';
import 'package:plugintest/src/utils/bitmap_utils.dart';
import 'package:plugintest/src/utils/date_utils.dart';
...
*/
  ...
  factory Plugintest() => _instance;

  @visibleForTesting
  Plugintest.private(MethodChannel channel) : _channel = channel;

  static final Plugintest _instance =
      Plugintest.private(const MethodChannel(CHANNEL_FLUTTER_PLUGIN));
